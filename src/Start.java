public class Start {
	...
	public static void main(String[] args) throws Exception {
		...
		Line[] lines = { new Line(namesA, xaxisA, yaxisA, lengthsA), new Line(namesB, xaxisB, yaxisB, lengthsB),
				new Line(namesC, xaxisC, yaxisC, lengthsC), new Line(namesD, xaxisD, yaxisD, lengthsD), new Line(namesE, xaxisE, yaxisE, lengthsE),
				new Line(namesH, xaxisH, yaxisH, lengthsH) };
